...
cf_time='Fri Dec 18 14:51:24 GMT 2009'
chgrp=''
chmod='chmod'
chown=''
clocktype='clock_t'
...
config_arg5='-Doptimize=-O3'
config_argc='5'
config_args='-de -Dlibperl=cygperl5_10.dll -Dmksymlinks -Dusethreads -Doptimize=-O3'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
mydomain='.x-ray.at'
myhostname='reini'
myuname='cygwin_nt-5.1 reini 1.7.0(0.21853) 2009-12-04 17:08 i686 cygwin '
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
...
ccflags_nolargefiles='-DPERL_USE_SAFE_PUTENV -U__STRICT_ANSI__ -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include'
